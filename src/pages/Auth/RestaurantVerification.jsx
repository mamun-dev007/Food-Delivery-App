      ...
      <div className="card bg-base-100 shadow-md w-full max-w-lg text-center">
        <div className="card-body items-center">
          ...
          <p className="text-base-content/70 mt-2 max-w-md">
            {isRejected
              ? "Your restaurant application was not approved. Please contact support or re-apply with the correct information."
              : status === "active"
              ? "Your restaurant has been approved. You can now access your dashboard."
              : "Thank you for registering your restaurant. Our admin team is reviewing your application. You'll get dashboard access once your restaurant is approved."}
          </p>
          ...
          <div className="flex gap-3 mt-6">
            {status === "active" && (
              <Link to="/restaurant-owner/dashboard" className="btn btn-primary">
                Go to Dashboard
              </Link>
            )}
