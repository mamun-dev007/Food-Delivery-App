...
import { Bell, Bike, CheckCheck, Package, PartyPopper, TrendingUp, ShieldAlert } from "lucide-react";
...
export const notificationIcon = (type) =>
  type === "bonus"
    ...
    : type === "earnings"
      ? { icon: TrendingUp, tint: "bg-emerald-500/10 text-emerald-600" }
      : type === "progress"
        ? { icon: Bike, tint: "bg-sky-500/10 text-sky-600" }
        : type === "delivery"
          ? { icon: Package, tint: "bg-blue-500/10 text-blue-600" }
          : { icon: ShieldAlert, tint: "bg-primary/10 text-primary" };
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="mt-1 flex items-center gap-1 text-[11px] text-base-content/40">
                    <CheckCheck className="h-3 w-3" /> {timeAgo(n.time)}
                  </span>
                </span>
